  ...
  return (
    <div className="theme-webdesign min-h-screen bg-background text-foreground">
      <div className="relative flex min-h-screen">
        <aside
          className={cn(
            "fixed inset-y-0 left-0 z-40 hidden border-r border-border/60 bg-background/50 transition-[width] duration-200 lg:block",
        ...
        <main className={cn("min-w-0 flex-1", sidebarCollapsed ? "lg:pl-20" : "lg:pl-64")}>
          <header
            className={cn(
